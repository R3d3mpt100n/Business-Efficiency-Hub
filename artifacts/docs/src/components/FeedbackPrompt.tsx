      ...
      <div className="flex flex-wrap gap-2">
        {["Yes, it helped", "Somewhat", "Not really"].map((label) => (
          <button
            ...
            className="inline-flex items-center justify-center rounded-md border border-slate-300 bg-white px-3 py-1.5 text-sm font-medium text-slate-700 hover:bg-slate-100 hover:shadow-sm"
          >
            {label}
          </button>
        ))}
