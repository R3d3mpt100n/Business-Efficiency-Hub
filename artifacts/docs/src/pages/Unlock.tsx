...
import { USER_CODE, grantUserAccess } from "@/lib/access";
...
const LOCKOUT_REDIRECT_MS = 5000;
...
export default function Unlock() {
  ...
  useEffect(() => {
    ...
    if (n >= MAX_ATTEMPTS) {
      ...
      setMessageTone("info");
      setMessage(
        "Access denied. Please complete purchase to receive a valid code.",
      );
      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <input
            ...
            className="w-full rounded-md border border-slate-300 px-3 py-2.5 text-slate-900 placeholder-slate-400 tracking-wide focus:outline-none focus:border-slate-900 disabled:bg-slate-50 disabled:text-slate-400"
          />
